using System;
using MidnightTestTask.Scripts.Player.InputPlayer;
using Photon.Pun;
using UnityEngine;
...
namespace MidnightTestTask.Scripts.Car
{
  ...
  {  
    ...
    private void Start()
    {
      ...
      tireScreechSound = GameObject.Find("TireScreechSound")?.GetComponent<AudioSource>();
      ...
      if(useTouchControls){
        if(throttleButton != null && reverseButton != null &&
          ...
          String ex = "Touch controls are not completely set up."; 
          Debug.LogWarning(ex);
        }
      }
